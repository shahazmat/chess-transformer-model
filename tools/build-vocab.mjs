...
const tokens = [...cores, ...MODIFIER_TOKENS, ...NERF_TOKENS];
...
console.log(`${tokens.length} tokens = ${cores.length} cores + ${MODIFIER_TOKENS.length} modifiers + ${NERF_TOKENS.length} nerf`);
